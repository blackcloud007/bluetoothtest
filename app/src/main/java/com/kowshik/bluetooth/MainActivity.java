...
public class MainActivity extends AppCompatActivity {
    ...
    Button listen,send1,send2,send3,send4,send5, listDevices;
    ListView listView;
    ...
    private void implementListeners() {
        ...
        send1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String string= String.valueOf(1);//writeMsg.getText());
        ...
        send2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String string= String.valueOf(2);//writeMsg.getText());
                sendReceive.write(string.getBytes());
            }
        });
        send3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String string= String.valueOf(3);//writeMsg.getText());
                sendReceive.write(string.getBytes());
            }
        });
        send4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String string= String.valueOf(4);//writeMsg.getText());
                sendReceive.write(string.getBytes());
            }
        });
        send5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String string= String.valueOf(5);//writeMsg.getText());
                sendReceive.write(string.getBytes());
            }
        });
    }
